      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8 w-full max-w-md shadow-2xl">
          ...
          <form onSubmit={submit} className="flex flex-col gap-4">
            <input
              className="bg-slate-700 border border-slate-600 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-indigo-500 w-full"
            ...
            />
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-lg transition w-full">
              Login
            </button>
          </form>
